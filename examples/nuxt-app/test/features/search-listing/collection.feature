Feature: Collection pages
  ...
  Example: Emergency resource portal
    Given the endpoint "/api/tide/page" with query "?path=/emergency-recovery-resource-portal-search-for-resource&site=8888" returns fixture "/collection/emergency-resource" with status 200
