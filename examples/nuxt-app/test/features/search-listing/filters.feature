Feature: Search listing - Filter
  ...
  #   When I visit the page "/filters?page=2"
  #   And I toggle the search listing filters section
  #   Then the search listing page should have 2 results

  #   And the search network request should be called with the "/search-listing/filters/request-apply-empty" fixture
  #   Then the URL should reflect that the current active filters are as follows:
  #     | id             |
  #     | rawFilter      |
  #     | termFilter     |
  ...
  #   When I toggle the "Dogs" option in the search listing dropdown field labelled "Raw filter example"
  #   When I toggle the "Green" option in the search listing dropdown field labelled "Term filter example"
  #   When I toggle the "Purple" option in the search listing dropdown field labelled "Terms filter example"
  #   When I toggle the "Closed" option in the search listing dropdown field labelled "Custom function filter example"

  #   Then the search input should have the value "test123"
  #   Then the search listing dropdown field labelled "Raw filter example" should have the value "Dogs"
  #   Then the search listing dropdown field labelled "Term filter example" should have the value "Green"
  #   Then the search listing dropdown field labelled "Terms filter example" should have the value "Purple"
  #   Then the search listing dropdown field labelled "Custom function filter example" should have the value "Closed"
  ...
  #   # When I submit the form with ID "tide-search-filter-form"
  #   When I wait 2 seconds

  #   And the search network request should be called with the "/search-listing/filters/request-apply-filled" fixture
  ...
  #     | termFilter     | Green  |
  #     | termsFilter    | Purple |
  #     | functionFilter | closed |


  @mockserver
  Example: Apply filters asd
    Given the endpoint "/api/tide/page" with query "?path=/filters&site=8888" returns fixture "/search-listing/filters/page" with status 200
    And the search network request is stubbed with fixture "/search-listing/filters/response" and status 200
    And the current date is "Fri, 02 Feb 2050 03:04:05 GMT"
