...
import RplResponsiveImage from './RplResponsiveImage.vue'
import { RplImageFit, RplImagePriority } from './constants'
import { a11yStoryCheck } from './../../../stories/interactions.js'

export const SingleTemplate = (args) => ({
  components: { RplResponsiveImage },
  setup() {
    return { args }
  },
  template: '<RplResponsiveImage v-bind="args" />'
})

<Meta
  title='Core/Containers/Image'
  component={RplResponsiveImage}
  argTypes={{
    height: {
      control: { type: 'number' }
    },
...
<ArgsTable of={RplResponsiveImage} />
